...
<div class="center">
    ...
    <div id="form" class="form_cadastro">
        ...
        <div class="txt_field">
          <input type="text" name="cpf" onkeyup="formatarCPF(this)" onchange="formatarCPF(this)" minlength="11" maxlength="14"  data-name="CPF" required>
          <span></span>
        ...
        <div class="txt_field">
          <input type="text" name="data_nascimento" oninput="formatarData(this)" minlength="8" maxlength="10" data-name="Data de Nascimento" required>
          <span></span>
